...
@section('title_and_meta')
    <title>Novels Listing | {{ config('app.name', 'Laravel') }}</title>
    <meta name="description" content="Daftar Novel yang terdaftar di NovelBaru" />

    <!-- Social Meta Tags -->
    <meta property="og:title" content="Novels Listing | {{ config('app.name', 'Laravel') }}"/>
    ...
    <meta name="twitter:title" content="Novels Listing | {{ config('app.name', 'Laravel') }}" />
...
<div class="row">
	<div class="col-xs-12">
		<h2>Novels Listing</h2>
		<div class="row">
			<div class="col-lg-6 col-xs-12 col-md-12">
				<div class="btn-group btn-group-sm pull-left mobile-center">
					<a href="{{ route('index.novel.list', ['orderby' => 'favorites', 'order' => $order]) }}" class="btn btn-default <?php if($orderby == 'favorites'){echo "active";} ?>">
						<span class="glyphicon glyphicon-heart"></span>
						Jumlah Favorite
					</a>
					<a href="{{ route('index.novel.list', ['orderby' => 'judul', 'order' => $order]) }}" class="btn btn-default <?php if($orderby == 'judul'){echo "active";} ?>">Judul Novel</a>
					<a href="{{ route('index.novel.list', ['orderby' => 'tanggal', 'order' => $order]) }}" class="btn btn-default <?php if($orderby == 'tanggal' || $orderby == 'created_at'){echo "active";} ?>">
			...
			<div class="col-lg-6 col-xs-12 col-md-12">
				<div class="btn-group btn-group-sm pull-right mobile-center">
					<a href="{{ route('index.novel.list', ['orderby' => $orderby, 'order' => 'asc']) }}" class="btn btn-default <?php if($order == 'asc'){echo "active";} ?>">
						<i class="fa fa-sort-amount-asc" aria-hidden="true"></i>
						Ascending
					</a>
					<a href="{{ route('index.novel.list', ['orderby' => $orderby, 'order' => 'desc']) }}" class="btn btn-default <?php if($order == 'desc'){echo "active";} ?>">
		...
		<div class="row">
			...
			<div class="col-lg-8 col-xs-12 col-md-12 text-center">
	            ...
	            <div>
	            	...
	            	<a href="{{ route('index.novel', ['slug' => $novel->slug_novel]) }}" class="btn btn-block btn-success pull-right">Read More</a>
	            	<div class="hidden-lg">
	            		<br><br>
	            	</div>
	            </div>
