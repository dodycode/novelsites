...
<section class="content container-fluid">
  ...
  <div class="row">
  				...
  				<table class="table table-hover">
  					...
  					<tbody>
  						...
  						<tr>
  							<td>{{ $ft->nama_ft }}</td>
  							<td>
  								<button role="links" class="btn btn-success btn-sm" data-href="{{ route('admin.requestjoin.accept', ['namaft' => $ft->nama_ft]) }}" data-toggle="modal" data-target="#modal1">
  									Terima Permintaan
  								</button>

                  <button role="links" class="btn btn-danger btn-sm" data-href="{{ route('admin.requestjoin.decline', ['namaft' => $ft->nama_ft]) }}" data-toggle="modal" data-target="#modal1">
                    Tolak Permintaan
                  </button>
      ...
      <div class="alert alert-success text-center">
        Tidak ada satupun permintaan untuk saat ini
      </div>
      @endif
  	</div>
  </div>
