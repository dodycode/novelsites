	...
	<div class="row">
		...
		<div class="col-xs-12">
			<div class="box">
				...
				<form role="form" method="POST" action="{{ route('admin.genre.submitEdit', ['id' => $genre->id]) }}">
					{{ csrf_field() }}
					<div class="box-body">
						<div class="form-group">
							<label>Nama Genre</label>
							<input type="text" name="nama_genre" value="{{ $genre->nama_genre }}" class="form-control" required>
						</div>
					</div>
