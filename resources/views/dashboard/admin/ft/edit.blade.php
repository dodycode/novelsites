		...
		<div class="col-xs-12">
			<div class="box">
				<div class="box-header with-border">
					<h3 class="box-title">Edit Fan Translation</h3>
				</div>
				<form role="form" method="POST" action="{{ route('admin.ft.storeEdit', ['id' => $ft->id]) }}">
					{{ csrf_field() }}
					<div class="box-body">
						<div class="form-group">
							<label>Nama Fan Translation</label>
							<input type="text" name="nama_ft" value="{{ $ft->nama_ft }}" class="form-control" required>
						</div>
						<div class="form-group">
							<label>Alamat Website Fan Translation</label>
							<input type="url" name="url" value="{{ $ft->url }}" class="form-control" placeholder="misal: http://btl.com" required>
